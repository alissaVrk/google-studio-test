...
const Hero: React.FC<HeroProps> = ({ profile, onChatClick }) => {
  return (
    <section className="relative w-full min-h-[90vh] flex items-center justify-center bg-orange-50 overflow-hidden">
      ...
      <div className="absolute -bottom-32 left-20 w-80 h-80 bg-green-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-float" style={{ animationDelay: '4s' }}></div>
      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="flex-1 w-full max-w-md md:max-w-xl relative group">
          <div className="absolute inset-0 bg-gradient-to-tr from-green-400 to-yellow-300 rounded-[2rem] rotate-3 group-hover:rotate-6 transition-transform duration-500 blur-sm opacity-50"></div>
          <img 
